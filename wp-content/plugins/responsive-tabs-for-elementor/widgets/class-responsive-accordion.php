              ...
              <ul class="responsive-tabs-list">
                  ...
                  foreach ($settings['tab'] as $item) { ?>
                    <li class="responsive-tab <?php if ($counter === 1) { ?>active-tab <?php } ?> tab-desktop">
                      <div class="responsive-tab-info <?php if ($item['sub_tabs_to_show']) { echo 'subtitle-item'; } ?>">
                        <div class="accordion-wrapper-counter">
                        <a class="responsive-tab-link responsive-tab-link-counter" href=<?php echo esc_url("#responsive-tab-$counter") ?>>
                          <span>
                              <?php if ($counter < 10) echo '0'; echo $counter; ?>
                          </span>
                        </a>
                        </div>
                          ...
                          <div class="accordion-item-title">
                            <h2 class="responsive-tab-name">
                              <a class="responsive-tab-link" href=<?php echo esc_url("#responsive-tab-$counter") ?>>
                                <span><?php echo wp_kses($item['tab_name'], array()); ?></span>
                                <div class="accordion-arrow"><span class="icon-arrow"><?php Icons_Manager::render_icon($settings['icon_arrow']); ?></span></div>
                              </a>
                            </h2>
                          </div>
