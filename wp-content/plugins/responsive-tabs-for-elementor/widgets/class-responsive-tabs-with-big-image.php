...
class Responsive_Tabs_With_Big_Image extends Widget_Base
{
    ...
    public function __construct($data = array(), $args = null)
    {
        ...
        wp_register_style('responsive-tabs', plugins_url('/assets/css/responsive-tabs.css', RESPONSIVE_TABS_FOR_ELEMENTOR), array(), '5.0.0');
        ...
        if (get_plugin_data(ELEMENTOR__FILE__)['Version'] >= "3.5.0") {
            wp_register_script('responsive-tabs', plugins_url('/assets/js/responsive-tabs-widget-handler.js', RESPONSIVE_TABS_FOR_ELEMENTOR), ['elementor-frontend'], '5.0.0', true);
        } else {
            wp_register_script('responsive-tabs', plugins_url('/assets/js/responsive-tabs-widget-old-elementor-handler.js', RESPONSIVE_TABS_FOR_ELEMENTOR), ['elementor-frontend'], '5.0.0', true);
        }
    }
            ...
            <section class="responsive-tabs-section responsive-tabs-scroll-section responsive-tabs-big-image-section">
                <ul class="responsive-tabs-image-list">
                    ...
                    foreach ($settings['tab'] as $item) { ?>
                        <li class="responsive-tab-image <?php if ($counter === 1) { ?>active-tab<?php } ?> tab-<?php echo $counter; ?>">
                            <img src="<?php echo esc_url($item['tab_image']['url']) ?>" style="object-fit: <?php echo esc_attr( $settings['image_block_filling'] ) ?>; object-position: <?php echo esc_attr( $settings['image_position'] ) ?>;">
                        </li>
                        <?php $counter++;
                    } ?>
                </ul>
                <div class="responsive-tab-wrapper">
                    <div class="responsive-tabs-block">
                        <ul class="responsive-tabs-list responsive-tabs-with-scroll">
                            <?php $counter = 1;
                            foreach ($settings['tab'] as $item) { ?>
                                <li class="tab-<?php echo $counter; ?> responsive-tab <?php if ($counter === 1) { ?>active-tab<?php } ?>">
                                    <div class="responsive-tab-info">
                                        <span class="responsive-tab-icon">
                                            <a class="responsive-tab-link" href=<?php echo esc_url("#responsive-tab-$counter") ?>><?php Icons_Manager::render_icon($item['tab_icon'], [ 'aria-hidden' => 'true' ]) ?></a>
                                        </span>
                                        <h2 class="responsive-tab-name">
                                            <a class="responsive-tab-link" href=<?php echo esc_url("#responsive-tab-$counter") ?>><?php echo wp_kses($item['tab_name'], array()); ?></a>
                                        </h2>
                                    </div>
                                </li>
                                <?php $counter++;
                        ...
                        <div class="tab-scroll-angle tab-scroll-angle-left">
                            <span class="icon-angle-left"><?php Icons_Manager::render_icon($settings['icon_scroll_left'], [ 'aria-hidden' => 'true' ]) ?></span>
                        </div>
                        <div class="tab-scroll-angle tab-scroll-angle-right">
                            <span class="icon-angle-right"><?php Icons_Manager::render_icon($settings['icon_scroll_right'], [ 'aria-hidden' => 'true' ]) ?></span>
                        </div>
                    </div>
                                ...
                                <ul class="responsive-sub-tab-name">
                                    <?php for ($i = 1; $i <= (int)$item['sub_tabs_to_show']; $i++) { ?>
                                        <li class="sub-tab-name <?php if ($i === 1) { ?>active-sub-tab<?php } ?>">
                                            <h3>
                                                <a href=<?php echo esc_url("#responsive-sub-tab-$counter-$i") ?>><?php echo wp_kses($item["sub_tab_name_" . $i], array()); ?></a>
                                            </h3>
                                            <div class="sub-tab-content-accordion"><?php echo wp_kses_post($item["sub_tab_content_" . $i], array()); ?></div>
                                        </li>
                                    <?php } ?>
                                </ul>
                            <?php } else { ?>
