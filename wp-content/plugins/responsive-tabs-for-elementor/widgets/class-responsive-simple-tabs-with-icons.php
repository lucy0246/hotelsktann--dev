...
class Responsive_Simple_Tabs_With_Icons extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        if ($settings['tab']) { ?>
            ...
            <section class="responsive-tabs-section responsive-tabs-big-image-section responsive-tabs-images-section responsive-simple-tabs-section">
                                    ...
                                    <ul class="responsive-sub-tab-name">
                                        <?php for ($i = 1; $i <= (int)$item['sub_tabs_to_show']; $i++) { ?>
                                            <li class="sub-tab-name <?php if ($i === 1) { ?>active-sub-tab <?php } ?>">
                                                <h3>
                                                    <a href=<?php echo esc_url("#responsive-sub-tab-$counter-$i") ?>><span><?php echo wp_kses($item["sub_tab_name_" . $i], array()); ?></span></a>
                                                </h3>
